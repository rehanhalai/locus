...
from app.modules.cases.schemas import CaseCreate, CaseUpdate, CaseResponse, CaseDetailResponse
...
def list_cases(
    status: Optional[CaseStatus] = Query(None, description="Filter by case status: ACTIVE, ARCHIVED, CLOSED"),
    search: Optional[str] = Query(None, description="Search keyword matching case number, name, or investigator"),
